        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                <el-form
                    ...
                    :rules="rules"
                >
                    <FormItem :label="t('cms.link.name')" type="string" v-model="baTable.form.items!.name" prop="name" :placeholder="t('Please input field', { field: t('cms.link.name') })" />
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    update_time: [buildValidatorData({ name: 'date', title: t('cms.link.update_time') })],
    create_time: [buildValidatorData({ name: 'date', title: t('cms.link.create_time') })],
    delete_time: [buildValidatorData({ name: 'date', title: t('cms.link.delete_time') })],
})
</script>
