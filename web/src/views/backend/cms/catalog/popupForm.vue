        ...
        >
          <el-tabs tab-position="left" class="catalog-tabs">
            <el-tab-pane :label="t('cms.catalog.base')">
              ...
              />
              <FormItem
                :label="t('cms.catalog.links_type')"
                type="radio"
                v-model="baTable.form.items!.links_type"
                :input-attr="{ size: 'large' }"
                :data="{
                  childrenAttr: { border: true },
                  content: { 0: '默认', 1: '指定' },
              ...
              />
              <ElLinkSelect
                v-model="baTable.form.items!.links_value"
                size=""
                :label="t('cms.catalog.links_value')"
                prop="links_value"
                :show="baTable.form.items!.links_type == '1'"
              ></ElLinkSelect>
              <FormItem
                :label="t('cms.catalog.description')"
                type="textarea"
              ...
              />
              <FormItem
                :label="t('cms.catalog.catdir')"
                type="string"
                v-model="baTable.form.items!.catdir"
                prop="catdir"
                :input-attr="{
                  placeholder: t('Please input field', {
              ...
              <FormItem
                label="多栏目设置"
                type="checkbox"
                v-model="baTable.form.items!.chage_all"
                :input-attr="{ size: 'large' }"
                :data="{
                  childrenAttr: { border: true },
              ...
              <el-form-item
                :label="t('cms.catalog.template_index')"
                prop="template_index"
              >
                <el-select
                  v-model="baTable.form.items!.template_index"
                  clearable
                  :placeholder="
                    t('Please select field', { field: t('cms.catalog.template_index') })
                  "
                  class="w100"
                >
                  <el-option
                    v-for="item in state.temp.index"
                    :key="item"
                    :label="item"
                    :value="item"
                  />
              ...
              <el-form-item :label="t('cms.catalog.template_info')" prop="template_info">
                <el-select
                  v-model="baTable.form.items!.template_info"
                  clearable
                  :placeholder="
                    t('Please select field', { field: t('cms.catalog.template_info') })
                  "
                  class="w100"
                >
                  <el-option
            ...
            <el-tab-pane :label="t('cms.catalog.seo')">
              <FormItem
                :label="t('cms.catalog.seo_title')"
                type="string"
                v-model="baTable.form.items!.seo_title"
                prop="seo_title"
                :input-attr="{
                  placeholder: t('Please input field', {
              ...
              />
              <FormItem
                :label="t('cms.catalog.seo_keywords')"
                type="string"
                v-model="baTable.form.items!.seo_keywords"
                prop="seo_keywords"
                :input-attr="{
                  placeholder: t('Please input field', {
              ...
              />
              <FormItem
                :label="t('cms.catalog.seo_description')"
                type="textarea"
                v-model="baTable.form.items!.seo_description"
...
watch(
  ...
  (newVal) => {
    if (newVal) {
      state.temp.index = state.template[newVal || 1]!["index"];
      state.temp.info = state.template[newVal || 1]!["info"];
      // baTable.form.items!.template_index = ''
