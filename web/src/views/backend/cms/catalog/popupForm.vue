                    ...
                    <el-tabs tab-position="left" class="catalog-tabs">
                        <el-tab-pane :label="t('cms.catalog.base')">
                            ...
                            <FormItem
                                ...
                                :input-attr="{ size: 'large' }" :data="{
                                    childrenAttr: { border: true },
                                    content: { 0: '不显示', 1: '都显示', 2: '头部显示', 3: '底部显示' },
                                }" />
                            <FormItem
                                :label="t('cms.catalog.links_type')" type="radio"
                                v-model="baTable.form.items!.links_type" :input-attr="{ size: 'large' }" :data="{
                                    childrenAttr: { border: true },
                                    content: { 0: '默认', 1: '指定' },
                                }" />
                            <ElLinkSelect
                            ...
                            <FormItem
                                ...
                                v-model="baTable.form.items!.description" prop="description" :input-attr="{
                                    rows: 3,
                            ...
                            <FormItem
                                ...
                                v-model.number="baTable.form.items!.weigh" :input-attr="{
                                    step: '1',
    ...
    placeholder: t('Please select field', {
        field: t('cms.catalog.status'),
                            ...
                            <el-form-item :label="t('cms.catalog.template_index')" prop="template_index">
                                <el-select
                                    v-model="baTable.form.items!.template_index" clearable :placeholder="t('Please select field', { field: t('cms.catalog.template_index') })
                                    " class="w100">
