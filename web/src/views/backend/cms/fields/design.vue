...
import { fieldItem, designTypes, tableFieldsKey } from '/@/views/backend/cms/fields/index'
import type { FieldItem } from '/@/views/backend/cms/fields/index'
import { cloneDeep, range, isEmpty } from 'lodash-es'
import Sortable, { SortableEvent } from 'sortablejs'
import { useTemplateRefsList } from '@vueuse/core'
import { changeStep, state as crudState, getTableAttr } from '/@/views/backend/cms/fields/index'
import { ElNotification, FormItemRule, FormInstance, ElMessageBox } from 'element-plus'
import { getDatabaseList, getFileData, generateCheck, generate, parseFieldData, postLogStart } from '/@/api/backend/cms/fields'
