...
const baTable = new baTableClass(
  new baTableApi('/admin/cms.slide.Data/'),
  {
    ...
    column: [
      ...
      {
        label: t('cms.slide.data.slide__name'),
        prop: 'slide.name',
        align: 'center',
      ...
      {
        label: t('cms.slide.data.status'),
        prop: 'status',
        align: 'center',
        render: 'tag',
        operator: 'eq',
        sortable: false,
        replaceValue: {'0': t('cms.slide.data.status 0'), '1': t('cms.slide.data.status 1')}
      },
      {
        label: t('cms.slide.data.group'),
        prop: 'group',
        align: 'center',
        operatorPlaceholder: t('Fuzzy query'),
        operator: 'LIKE',
      ...
      {
        label: t('cms.slide.data.create_time'),
        prop: 'create_time',
        align: 'center',
        render: 'datetime',
        operator: 'RANGE',
      ...
      {
        label: t('cms.slide.data.update_time'),
        prop: 'update_time',
        align: 'center',
        render: 'datetime',
        operator: 'RANGE',
