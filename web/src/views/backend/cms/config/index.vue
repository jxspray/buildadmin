                                ...
                                <div class="config-item" :style="{background:item.background}">
                                    <div class="tip-container">
                                        <div class="config-item-icon-container"
                                            ...
                                            <div class="item-icon-1"><img :src="'/src/assets/addons/cms/img/config/' + item.icon + '.png'"  alt=""/>
                                            </div>
                                    ...
                                    <div class="set-container">
                                        ...
                                        <div class="config-item-btn display-flex-c" :style="item.button" @click="operation(name, item.id,item.title)">立即设置</div>
                                    </div>
                                </div>
                            </el-col>
                        </el-row>
...
const loadOperation = (group: string|number, id: string) => {
    state.type = id
