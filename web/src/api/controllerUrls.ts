...
export const cmsArticle = '/admin/cms.article/'
export const cmsSolution = '/admin/cms.solution/'
export const cmsCatalog = '/admin/cms.catalog/'
export const cmsModule = '/admin/cms.module/'
