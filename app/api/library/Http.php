...
//        }
     ...
     * @return boolean TRUE
     */
    public static function sendAsyncRequest($url, $params = [], $method = 'POST'): bool
    {
        $method = strtoupper($method);
     ...
     */
    public static function sendToBrowser(string $file, bool $delaftersend = true, bool $exitaftersend = true)
    {
