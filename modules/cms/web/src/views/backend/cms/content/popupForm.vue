    ...
    >
        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                <FormItem :label="t('routine.cms.catalog.moduleid')" type="number" prop="moduleid" v-model.number="baTable.form.items!.moduleid" :input-attr="{ step: '1', placeholder: t('Please input field', { field: t('routine.cms.catalog.moduleid') }) }" />
