    ...
    >
        ...
        <el-scrollbar v-loading="baTable.form.loading" class="ba-table-form-scrollbar">
            ...
            >
                ...
                <FormItem :label="t('cms.catalog.module_id')" type="number" prop="module_id" v-model.number="baTable.form.items!.module_id" :input-attr="{ step: '1', placeholder: t('Please input field', { field: t('cms.catalog.module_id') }) }" />
